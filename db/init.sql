...
alter table "programs"."SiliconFeatureEntries" add constraint "sfeF_FK" foreign key("featureId") references "programs"."Features"("featureId") on update CASCADE on delete CASCADE;
...
alter table "programs"."CarbonFeatureEntries" add constraint "cfeF_FK" foreign key("featureId") references "programs"."Features"("featureId") on update CASCADE on delete CASCADE;
