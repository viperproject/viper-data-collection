...
create table if not exists "programs"."UserSubmissions" ("submissionId" BIGSERIAL NOT NULL PRIMARY KEY,"submissionDate" TIMESTAMP NOT NULL,"program" VARCHAR NOT NULL,"loc" INTEGER NOT NULL,"frontend" VARCHAR NOT NULL,"argsBlob" BYTEA NOT NULL,"originalVerifier" VARCHAR NOT NULL,"success" BOOLEAN NOT NULL,"runtime" BIGINT NOT NULL);
create table if not exists "programs"."ProgramEntries" ("programEntryId" BIGSERIAL NOT NULL PRIMARY KEY,"submissionDate" TIMESTAMP NOT NULL,"program" VARCHAR NOT NULL,"loc" INTEGER NOT NULL,"frontend" VARCHAR NOT NULL,"originalVerifier" VARCHAR NOT NULL,"args" BYTEA NOT NULL,"originalRuntime" BIGINT NOT NULL,"parseSuccess" BOOLEAN NOT NULL);
