...
create table if not exists "programs"."SiliconResults" ("silResId" BIGSERIAL NOT NULL PRIMARY KEY,"creationDate" TIMESTAMP NOT NULL,"verifierHash" VARCHAR NOT NULL,"programEntryId" BIGINT NOT NULL,"success" BOOLEAN NOT NULL,"runtime" BIGINT NOT NULL,"errors" BYTEA NOT NULL,"phaseRuntimes" BYTEA NOT NULL,"benchmarkResults" BYTEA NOT NULL);
